  ...
  return (
    <div>
      ...
      <div className="mt-16">
        ...
        <h2 className="text-center font-semibold italic text-3xl">
          01 Concept
        </h2>
        <h2 className="text-3xl mt-4 text-center font-serif text-[#c7b72c]">
          DEVELOPMENT
        </h2>
        <p className="px-5">
      ...
      <div className="mt-16">
        <img src={heroImg2} alt="hero_Img" className="size-80 w-full" />
        <h2 className="text-center font-medium italic text-3xl">02 Design</h2>
        <h2 className="text-3xl mt-4 text-center font-serif text-[#c7b72c]">
          PRESENTATION
        </h2>
        <p className="px-5">
      ...
      <div className="mt-16">
        <img src={heroImg2} alt="hero_Img" className="size-80 w-full" />
        <h2 className="text-center font-medium italic text-3xl">
          03 Construction
        </h2>
        <h2 className="text-3xl mb-2 text-center font-serif text-[#c7b72c]">
          DOCUMENTATION
        </h2>
        <p className="px-5">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis nisi
      ...
      <div className="mt-16">
        <img src={heroImg2} alt="hero_Img" className="size-80 w-full" />
        <h2 className="text-center font-medium italic text-3xl">04 DESIGN</h2>
        <h2 className="text-3xl mb-2 text-center font-serif text-[#c7b72c]">
          MANAGEMENT
        </h2>
        <p className="px-5">
      ...
      <div className="mt-16">
        <img src={heroImg2} alt="hero_Img" className="size-80 w-full" />
        <h2 className="text-center font-medium italic text-3xl">06 Turnkey</h2>
        <h2 className="text-3xl mb-2 text-center font-serif text-[#c7b72c]">
          INSTALLATION
        </h2>
        <p className="px-5">
      ...
      <div className="mt-20 text-center mx-auto w-2/3">
        <button className="p-2 border-2 border-[#c7b72c]">
          GET CONSULTATION
        </button>
      ...
      <div className="mt-20">
        <h2 className="text-center font-semibold p-4 bg-[#c7b72c]">
          MEET OUR TEAM
        </h2>
      </div>
